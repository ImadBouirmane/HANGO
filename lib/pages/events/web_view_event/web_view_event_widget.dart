...
class WebViewEventWidget extends StatefulWidget {
  const WebViewEventWidget({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EventsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final webViewEventEventsRecord = snapshot.data!;
        return Title(
            title: 'WebViewEvent',
            ...
            child: GestureDetector(
              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  title: AutoSizeText(
                    webViewEventEventsRecord.siteWeb,
                    maxLines: 1,
                ...
                body: SafeArea(
                  ...
                  child: Column(
                    ...
                    children: [
                      FlutterFlowWebView(
                        content: webViewEventEventsRecord.siteWeb,
                        bypass: false,
