    ...
    return StreamBuilder<List<EventsRecord>>(
      stream: queryEventsRecord(
        queryBuilder: (eventsRecord) => eventsRecord
            .where('type', isEqualTo: widget.themeEvent)
            .where('music_sytle', arrayContains: widget.musicType),
      ),
      builder: (context, snapshot) {
        ...
        List<EventsRecord> eventFilterResultEventsRecordList = snapshot.data!;
        return Title(
            ...
            child: GestureDetector(
              ...
              child: WillPopScope(
                ...
                child: Scaffold(
                  ...
                  body: Builder(
                    builder: (context) {
                      if (eventFilterResultEventsRecordList.length != null) {
                        return Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final listEvents =
                                  eventFilterResultEventsRecordList.toList();
                                  ...
                                  return Align(
                                    ...
                                    child: StreamBuilder<EstablishmentsRecord>(
                                      stream: EstablishmentsRecord.getDocument(
                                          listEventsItem.establishmentId!),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
                                          return Center(
