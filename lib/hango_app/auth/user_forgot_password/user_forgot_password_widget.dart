...
class UserForgotPasswordWidget extends StatefulWidget {
  const UserForgotPasswordWidget({Key? key}) : super(key: key);
...
class _UserForgotPasswordWidgetState extends State<UserForgotPasswordWidget> {
  late UserForgotPasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserForgotPasswordModel());
                        ...
                        children: [
                          Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'USER_FORGOT_PASSWORD_keyboard_return_rou');
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'USER_FORGOT_PASSWORD_Button-Login_ON_TAP');
