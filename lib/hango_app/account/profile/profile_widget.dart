                            ...
                            child: Column(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_PAGE_LinkToUserLogin_ON_TAP');
                                    logFirebaseEvent(
                                      ...
                                      if (!loggedIn)
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'PROFILE_Button-create-account_ON_TAP');
                                              logFirebaseEvent(
                                        ...
                                        Padding(
                                          ...
                                          child: AuthUserStreamWidget(
                                            builder: (context) =>
                                              ...
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'PROFILE_PAGE_Button-NT-Dashboard_ON_TAP');
                                                logFirebaseEvent(
                                      ...
                                      if (loggedIn)
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'PROFILE_PAGE_Button-Logiout_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button-Logiout_auth');
                                              GoRouter.of(context)
                                                  .prepareAuthEvent();
                                                    ...
                                                    child: Stack(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child:
                                                            ...
                                                            builder:
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'PROFILE_PAGE_CircleImage_pjb59fr1_ON_TAP');
                                                                logFirebaseEvent(
                                                        ...
                                                        FlutterFlowIconButton(
                                                          ...
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'PROFILE_PAGE_camera_alt_ICN_ON_TAP');
                                                            logFirebaseEvent(
                                                    ...
                                                    children: [
                                                                ...
                                                                AuthUserStreamWidget(
                                                                  builder: (context) =>
                                                                    ...
                                                                    controller: _model
                                                                        ...
                                                                        FormFieldController<
                                                                            String>(
                                                                      _model.genreValue1 ??= valueOrDefault(
                                                                          currentUserDocument
                                                                              ?.gender,
                                                                          ''),
                                                                    ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'PROFILE_PAGE_MODIFIER_BTN_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Button_backend_call');
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              'Vous n\'etes pas connecte a votre compte !',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium,
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'PROFILE_PAGE_AUTHENTIFIEZ_BTN_ON_TAP');
                                            logFirebaseEvent(
                                                'Button_navigate_to');
                                                            ...
                                                            child:
                                                              ...
                                                              builder:
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'PROFILE_PAGE_CircleImage_yrs2ddy9_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'CircleImage_expand_image');
                                                                  await Navigator
                                                                      .push(
                                                                  ...
                                                                  AuthUserStreamWidget(
                                                                    builder: (context) =>
                                                                      ...
                                                                      controller: _model
                                                                          ...
                                                                          FormFieldController<
                                                                              String>(
                                                                        _model.genreValue2 ??= valueOrDefault(
                                                                      ...
                                                                      onChanged:
                                                                          (val) =>
                                                                              setState(() => _model.genreValue2 = val),
                                                                      width: MediaQuery.sizeOf(context)
                                                                              .width *
                                                                          1.0,
                                                                      height:
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'PROFILE_PAGE_Row_sdp8yg6f_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Row_navigate_to');
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'PROFILE_PAGE_Row_ppvrv8ww_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Row_auth');
                                                            GoRouter.of(context)
                                                                .prepareAuthEvent();
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'PROFILE_PAGE_Row_852r5ddm_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Row_navigate_to');
