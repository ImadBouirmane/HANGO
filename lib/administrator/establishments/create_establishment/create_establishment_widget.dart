...
class _CreateEstablishmentWidgetState extends State<CreateEstablishmentWidget> {
  ...
  void initState() {
    ...
    _model.tFMondayController ??= TextEditingController();
    _model.tFtuesdayController ??= TextEditingController();
    _model.tFWednesdayController ??= TextEditingController();
    _model.tFThursdayController ??= TextEditingController();
    _model.tFFridayController ??= TextEditingController();
    _model.tFSaturdayController ??= TextEditingController();
    _model.tFSundayController ??= TextEditingController();
                                      ...
                                      children: [
                                                                    ...
                                                                    onChanged: (val) =>
                                                                        setState(() =>
                                                                            _model.checkBoxMusicStyleValues =
                                                                                val),
                                                                    controller: _model
                                                                            .checkBoxMusicStyleValueController ??=
                                                                        FormFieldController<
                                                                            List<String>>(
                                                                      [],
                                                                    ),
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            await EstablishmentsRecord
                                              ...
                                              ...createEstablishmentsRecordData(
                                                ...
                                                speciality: _model
                                                    ...
                                                    .text,
                                                monday: _model
                                                    .tFMondayController.text,
                                                tuesday: _model
                                                    .tFtuesdayController.text,
                                                wednesday: _model
                                                    .tFWednesdayController.text,
                                                thursday: _model
                                                    .tFThursdayController.text,
                                                friday: _model
                                                    .tFFridayController.text,
                                                saturday: _model
                                                    .tFSaturdayController.text,
                                                sunday: _model
                                                    .tFSundayController.text,
                                                location: _model
                                                    .placePickerValue.latLng,
                                                description: _model
                                                    .tFDescriptionController
                                            ...
                                            setState(() {
                                              _model.tFNameController?.clear();
                                              _model.tFStreetController
                                                  ?.clear();
                                              _model.tFzipCodeController
                                                  ?.clear();
                                              _model.tFcityController?.clear();
                                              _model.tFstateController?.clear();
                                              _model.tFcountryController
                                                  ?.clear();
                                              _model.tFlatLngController
                                                  ?.clear();
                                              ...
                                              _model.tFspecialityController
                                                  ?.clear();
                                              _model.tFMondayController
                                                  ?.clear();
                                              _model.tFtuesdayController
                                                  ?.clear();
                                              _model.tFWednesdayController
                                                  ?.clear();
                                              _model.tFThursdayController
                                                  ?.clear();
                                              _model.tFFridayController
                                                  ?.clear();
                                              _model.tFSaturdayController
                                                  ?.clear();
                                              _model.tFSundayController
                                                  ?.clear();
